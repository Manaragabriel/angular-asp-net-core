        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    nome_lote = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Palestrante_eventos", x => new { x.PalestranteId, x.EventoId });
                    table.ForeignKey(
                        name: "FK_Palestrante_eventos_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Palestrante_eventos_Palestrantes_PalestranteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Palestrante_eventos_EventoId",
                table: "Palestrante_eventos",
                column: "EventoId");
